...
const OtpScreen: React.FC<{}> = () => (
  <View style={otpStyle.container}>
    <TopBar showLeftIcon headerText="" customContainerStyle={otpStyle.customHeader} />
    <View style={otpStyle.content}>
      <View style={otpStyle.iconLockAndTextWrapper}>
        <View style={otpStyle.iconLock}>
          <CustomIcon name="Lock" size={SIZES.spacing_32_horizontal} color={COLORS.white} />
        </View>
        <Text style={otpStyle.enterOtpCode}>Enter the OTP Code</Text>
        <Text style={otpStyle.sentOtpCode}>We’ve sent you an OTP code to</Text>
