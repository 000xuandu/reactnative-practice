...
export default function ParallelHeader() {
  ...
  const rImageStyle = useAnimatedStyle(() => ({
    ...
    transform: [
      {
        scale: interpolate(offsetY.value, [-SIZES.width * 2, 0], [8, 1], Extrapolate.CLAMP),
      },
    ],
  }));
  const onScrollEndDrag = () => {
    ...
    } else if (offsetY.value >= HEADER_SCROLL_DISTANCE * 0.5 && offsetY.value <= HEADER_SCROLL_DISTANCE) {
