...
const SignInScreen: React.FC<{}> = () => {
  ...
  const onChangeEmailOrPhoneText = React.useCallback((e: NativeSyntheticEvent<TextInputChangeEventData>) => {
  ...
  const onChangePasswordText = React.useCallback((e: NativeSyntheticEvent<TextInputChangeEventData>) => {
  ...
  return (
    <View style={signInStyle.container}>
      <View style={signInStyle.logoAndTextWrapper}>
        <Image source={Wave} resizeMode="cover" style={signInStyle.waveImageWrapper} />
      ...
      <Animated.View style={[signInStyle.signInFormWrapper, customSignInFormStyle]}>
        ...
        <View style={signInStyle.signUpWrapper}>
          <Text style={signInStyle.dontHaveAccYet}>Don’t have account yet?</Text>
          <TouchableOpacity>
